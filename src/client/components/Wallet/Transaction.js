  ...
  render() {
    ...
    if (this.props.tx.direction == 'in') {
      ...
      content = <div className="tx tx-out">
        ...
        <div style={{ width: '20%', minWidth: '100px' }}><p>{ this.date.toDateString() }</p></div>
        <div style={{ width: '5%', minWidth: '15px' }}><a href={ "https://stellar.expert/explorer/testnet/tx/" + this.props.tx.transaction_hash } target='_blank'><i className="material-icons tiny">call_made</i></a></div>
