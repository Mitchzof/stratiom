  ...
  render() {
    ...
    if (this.props.tx.direction == 'in') {
      content = <div className="tx tx-in">
        ...
        <div style={{ width: '5%', minWidth: '15px' }}><a href={ "https://stellar.expert/explorer/" + (TESTNET) ? 'testnet' : 'public' + "/tx/" + this.props.tx.transaction_hash } target='_blank'><i className="material-icons tiny">call_made</i></a></div>
