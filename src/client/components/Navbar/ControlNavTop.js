    ...
    return (
      <nav style={{ boxShadow: '0 1px 2px 0 rgba(0,0,0,.14), 0 2px 1px -2px rgba(0,0,0,.12), 0 1px 5px 0 rgba(0,0,0,.2)' }}>
        <div className="nav-wrapper cp-nav">
          ...
          <Link to="/"><div className="brand-logo logo-container" style={{color: '#505558', display: 'flex', alignItems: 'center'}}><img className="logo" src="/assets/logo.png" />Stratiom</div></Link>
